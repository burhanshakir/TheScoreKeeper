...
public class LoadFootballKnockout extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_load_football_knockout);
    ...
    private class  BackgroundTask extends AsyncTask<String,Void,String>
    {
        String login_url;
        Context ctx;
        ProgressDialog progress = new ProgressDialog(LoadFootballKnockout.this);
