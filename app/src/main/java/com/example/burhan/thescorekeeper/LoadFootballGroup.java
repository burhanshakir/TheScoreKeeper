...
public class LoadFootballGroup extends AppCompatActivity
{

    String tName,tId,tPw,oName,type,count,nog,keeper,alert7 ="Tournament Password: ";
    TextView matches;
    Intent intent;
    int flag =0;
    ImageButton create;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_load_football_group);
    ...
    public void access (View v)
    {
        ...
        String alert6 = "No of groups: " + nog;
    ...
    private class  BackgroundTask extends AsyncTask<String,Void,String>
    {
        String login_url;
        Context ctx;
        ProgressDialog progress = new ProgressDialog(LoadFootballGroup.this);
        ...
        {
            login_url = "http://burhanshakir.xyz/tsk_get_info_group.php";
